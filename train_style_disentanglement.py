...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--custom_instance_prompts_root",
        type=str, 
        default=None,
        help=("The path of custom instance prompts file."),
    )
...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
            ...
            repeats=1,
            center_crop=False,
            custom_instance_prompts_root=None,
    ):
        self.size = size
        self.center_crop = center_crop

        self.instance_prompt = instance_prompt
        self.custom_instance_prompts_root = custom_instance_prompts_root
        ...
        if args.dataset_name is not None:
            ...
            self.custom_instance_prompts = None
            if custom_instance_prompts_root:
                custom_instance_prompts = []
                with open(Path(custom_instance_prompts_root)) as f:
                    for line in f:
                        line = line.strip()
                        custom_instance_prompts.append(line)
...
def main(args):
    ...
    STYLE_BLOCKS = ['up_blocks.0.attentions.1']
    ...
    for attn_processor_name, attn_processor in unet.attn_processors.items():
        ...
        if not is_belong_to_groups(attn_processor_name, STYLE_BLOCKS):
            continue
        attn_module = unet
    ...
    train_dataset = DreamBoothDataset(
        ...
        custom_instance_prompts_root=args.custom_instance_prompts_root
    )
